          ...
          <div class="row">  
            <div class="col-md-12">  
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                      <label for="oldpassword">Adhar Card:</label><span><a href="{{url('/')}}/../{{$data->adhar_card}}"> View</a></span>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                      <label for="oldpassword">Pan Card:</label><span><a href="{{url('/')}}/../{{$data->pan_card}}"> View</a></span>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                      <label for="oldpassword">Booking Date:</label><span>{{$data->booking_date}}</span>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
