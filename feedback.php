...
<div class="container">
<div class="my-5">
  <h2 class="innerpageHeading text-center">Give us Feedback</h2>
  <div class="row">
    <div class="col-md-8 mx-auto">
      <div class="formsection mt-0">
        <form action="send_mail_feedback.php" method="post" data-parsley-validate="parsley" onsubmit="return submitUserForm();">
          ...
          <button type="submit" name="submit" class="new-button triggerBookAShowRoomVisitButton" value="Submit Feedback" style="width: auto;"><span> Submit Feedback </span></button>
        </form>
      </div>
    </div>
  </div>
