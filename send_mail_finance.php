...
if(isset($_POST['submit'])){
    ...
    // $message2 = "Hello Team, Below are the details of the person requested for the Nexa Finance service please call and proceed further."
    // ."\r\n\r\n"."Name : " .$full_name
    // ."\r\n"."Phone no : ". $phone_no
    // ."\r\n"."City : ".$city
    // ."\r\n"."Car model : ".$model
...
$message2.='<span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif"><strong>Thank you</strong></span></span></body>
    ...
    mail($admin,$subject2,$message2,$headers2); // sends a copy of the message to the sender
     ...
     include('connection.php');
        ...
        $sql = "INSERT INTO `nexa_finance`(`name`, `email`, `phone_no`, `city`, `model`, `annual_income`, `purchase_time_frame`, `message`) VALUES ('$full_name','$to','$phone_no','$city','$model','$annual_income','$purchase_time','$s_message')";
